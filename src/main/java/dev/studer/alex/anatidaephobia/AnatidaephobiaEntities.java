...
public class AnatidaephobiaEntities {
	...
	public static final EntityType<ThrownDuckEgg> THROWN_DUCK_EGG = Registry.register(
			BuiltInRegistries.ENTITY_TYPE,
			THROWN_DUCK_EGG_ID,
			EntityType.Builder.<ThrownDuckEgg>of(ThrownDuckEgg::new, MobCategory.MISC).noLootTable().sized(0.25f, 0.25f).clientTrackingRange(4).updateInterval(10).build(ResourceKey.create(
					Registries.ENTITY_TYPE,
					THROWN_DUCK_EGG_ID
			))
	);
	...
	public static void init() {
		FabricDefaultAttributeRegistry.register(DUCK, Duck.createMobAttributes());
	}
}
