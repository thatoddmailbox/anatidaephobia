...
//						Optional var10000 = Optional.ofNullable((EitherHolder)this.getItem().get(DataComponents.CHICKEN_VARIANT)).flatMap((v) -> v.unwrap((HolderLookup.Provider)this.registryAccess()));
